defmodule Tiki.Policy.Checks do
  ...
  def hive(%Accounts.Scope{user: user}, object, permission), do: hive(user, object, permission)
  ...
  def any_team_role(%Accounts.Scope{user: user}, object, role),
    do: any_team_role(user, object, role)
  ...
  def team_role(%Accounts.Scope{user: user}, object, role), do: team_role(user, object, role)
