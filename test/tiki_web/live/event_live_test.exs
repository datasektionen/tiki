defmodule TikiWeb.EventLiveTest do
  use TikiWeb.ConnCase

  import Phoenix.LiveViewTest
  import Tiki.EventsFixtures

  @create_attrs %{description: "some description", event_date: "2023-03-25T16:55:00Z", name: "some name"}
  @update_attrs %{description: "some updated description", event_date: "2023-03-26T16:55:00Z", name: "some updated name"}
